...
const contactLinks = [
  ...
  {
    href: "https://www.threads.com/@operavoai",
    label: "Threads",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
        <path d="M16.07 11.13c-.09-.04-.18-.08-.27-.12-.16-2.93-1.76-4.6-4.44-4.62h-.04c-1.6 0-2.94.69-3.76 1.93l1.48 1.01c.61-.93 1.57-1.13 2.28-1.13h.03c.88.01 1.55.27 1.98.76.31.36.52.86.62 1.49-.78-.13-1.62-.17-2.52-.12-2.53.15-4.16 1.62-4.05 3.67.05 1.04.57 1.93 1.46 2.51.75.49 1.72.73 2.73.68 1.33-.07 2.38-.58 3.11-1.51.55-.71.9-1.62 1.06-2.78.64.39 1.11.9 1.37 1.51.45 1.05.47 2.77-.93 4.17-1.23 1.23-2.7 1.76-4.92 1.78-2.46-.02-4.32-.81-5.53-2.35C2.08 16.04 1.5 14 1.48 11.99c.02-2.01.6-4.05 1.73-5.47 1.21-1.54 3.07-2.33 5.53-2.35 2.48.02 4.37.81 5.62 2.36.61.76 1.08 1.72 1.39 2.84l1.73-.46c-.37-1.38-.96-2.57-1.76-3.56C14.07 1.84 11.71.83 8.74.81h-.01C5.77.83 3.44 1.84 1.81 3.83.36 5.61-.39 8.08-.42 11.99v.01c.03 3.91.78 6.38 2.23 8.16 1.63 1.99 3.96 3 6.93 3.02h.01c2.64-.02 4.5-.71 6.04-2.25 2.01-2.01 1.95-4.53 1.29-6.08-.48-1.11-1.39-2.02-2.63-2.64zm-4.59 4.51c-1.12.06-2.28-.44-2.34-1.53-.04-.81.58-1.71 2.41-1.81.21-.01.41-.02.62-.02.66 0 1.28.06 1.84.19-.21 2.62-1.44 2.92-2.53 2.97z" />
      </svg>
    ),
  },
  {
    href: "https://x.com/OperavoAI",
    label: "X",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
