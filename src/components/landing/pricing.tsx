...
const sharedFeatures: Array<{ title: string; icon: React.ReactNode }> = [
  { title: "Live call log", icon: <IconLog /> },
  { title: "Calendar booking", icon: <IconCalendar /> },
  { title: "Lead scoring", icon: <IconSpark /> },
  { title: "SMS confirmation", icon: <IconChat /> },
  { title: "AI summary", icon: <IconSummary /> },
  { title: "CSV export", icon: <IconDownload /> },
];
